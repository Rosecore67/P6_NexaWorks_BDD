...
List<string> motsCles = new List<string> {"exportation", "bouton", "se ferme","financiers","bloque"};

var problemesMotsCles = (from t in Tickets
    ...
    .AsEnumerable()
    .Where(t => motsCles.Any(motCle => 
        t.Description_probleme != null && 
        t.Description_probleme.ToLower().Contains(motCle.ToLower()))) // Appliquer le filtre avec la gestion de casse
    .Dump();